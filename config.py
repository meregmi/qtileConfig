...
def autostart():
	subprocess.Popen(['/home/regmi/.config/qtile/autostart.sh'])
...
Key([mod, "control"], "h",
  ...
  # Multimedia keys 
    ...
    Key([], "XF86AudioRaiseVolume", lazy.spawn("amixer set Master 5%+"), desc="Raise volume level by 5%"),
    Key([], "XF86AudioLowerVolume", lazy.spawn("amixer set Master 5%-"), desc="Lower volume level by 5%"),
    Key([], "XF86AudioMute", lazy.spawn("amixer set Master 1+ toggle"), desc="Mute or unmute volume level"),

  # Applications
    Key([mod], "b", lazy.spawn("firefox"), desc="Launch Firefox"),
    Key([mod,"shift"], "l", lazy.spawn("slock"), desc="LockScreen"),
]
       ...
       top=bar.Bar(
            [
              # widget.CurrentLayout(),
                ...
                widget.Systray(),
		        widget.Volume(emoji="true",fontsize=12),
